...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class PriceListsController : EnovaApiController
    {
        ...
        [HttpGet()]
        [Authorize(Roles = AuthService.AdminRole)]
        [ProducesResponseType(typeof(IEnumerable<PriceListModel>), (int)HttpStatusCode.OK)]
        ...
        [HttpGet("{identifier}")]
        [Authorize(Roles = AuthService.AdminRole)]
        [ProducesResponseType(typeof(PriceListModel), (int)HttpStatusCode.OK)]
        ...
        /// <summary>
        /// Add a dynamic property to a pricelist.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaPriceList>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a pricelist.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaPriceList>(propertyName);
        }
    }
}
