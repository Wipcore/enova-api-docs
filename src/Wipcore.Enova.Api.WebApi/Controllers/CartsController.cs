...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class CartsController : EnovaApiController
    {
        ...
        public CartsController(EnovaApiControllerDependencies dependencies, ICartService cartService, IAuthService authService, IContextService contextService)
            : base(dependencies)
        {
        ...
        /// <summary>
        /// Add a dynamic property to a cart.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaCart>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a cart.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaCart>(propertyName);
        }
    }
}
