...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class TaxationRulesController : EnovaApiController
    {
        ...
        public TaxationRulesController(EnovaApiControllerDependencies dependencies)
            : base(dependencies)
        {
        ...
        {
            var found = _objectService.Exists<EnovaTaxationRule>(identifier);
            if (!found)
        ...
        {
            var found = _objectService.Exists<EnovaTaxationRule>(id);
            if (!found)
                Response.StatusCode = (int)HttpStatusCode.NotFound;
        }
        ...
        {
            return _objectService.GetMany<EnovaTaxationRule>(requestContext, query);
        }
