...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class PaymentTypesController : EnovaApiController
    {
        ...
        public PaymentTypesController(EnovaApiControllerDependencies dependencies)
            : base(dependencies)
        {
        ...
        /// <summary>
        /// Add a dynamic property to a paymenttype.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaPaymentType>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a paymenttype.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaPaymentType>(propertyName);
        }
    }
}
