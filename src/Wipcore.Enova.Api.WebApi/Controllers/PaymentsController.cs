...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class PaymentsController : EnovaApiController
    {
        ...
        [HttpGet()]
        [Authorize(Roles = AuthService.AdminRole)]
        [ProducesResponseType(typeof(IEnumerable<PaymentModel>), (int)HttpStatusCode.OK)]
        ...
        /// <summary>
        /// Add a dynamic property to a payment.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaPayment>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a payment.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaPayment>(propertyName);
        }
    }
}
