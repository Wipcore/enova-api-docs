...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class CompaniesController : EnovaApiController
    {
        ...
        public CompaniesController(EnovaApiControllerDependencies dependencies)
            : base(dependencies)
        {
        ...
        /// <summary>
        /// Add a dynamic property to a company.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaCompany>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a company.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaCompany>(propertyName);
        }
    }
}
