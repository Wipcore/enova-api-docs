...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class ShippingTypeCostsController : EnovaApiController
    {
        ...
        /// <summary>
        /// Add a dynamic property to a shippingtypecost.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaShippingTypeCost>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a shippingtypecost.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaShippingTypeCost>(propertyName);
        }
    }
}
