...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class CustomersController : EnovaApiController
    {
        ...
        /// <summary>
        /// Add a dynamic property to a customer.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaCustomer>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a customer.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaCustomer>(propertyName);
        }
    }
}
