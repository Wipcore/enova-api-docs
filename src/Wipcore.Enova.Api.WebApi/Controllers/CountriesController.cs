...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class CountriesController : EnovaApiController
    {
        ...
        public CountriesController(EnovaApiControllerDependencies dependencies)
            : base(dependencies)
        {
        ...
        /// <summary>
        /// Add a dynamic property to a country.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaCountry>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a country.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaCountry>(propertyName);
        }
    }
}
