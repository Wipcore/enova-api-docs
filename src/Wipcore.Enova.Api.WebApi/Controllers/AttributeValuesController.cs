...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class AttributeValuesController : EnovaApiController
    {
        ...
        [HttpGet()]
        [AllowAnonymous]
        [ProducesResponseType(typeof(IEnumerable<AttributeValueModel>), (int)HttpStatusCode.OK)]
        ...
        [HttpGet("{identifier}")]
        [AllowAnonymous]
        [ProducesResponseType(typeof(AttributeValueModel), (int)HttpStatusCode.OK)]
