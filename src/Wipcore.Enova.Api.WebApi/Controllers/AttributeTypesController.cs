...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class AttributeTypesController : EnovaApiController
    {
        ...
        public AttributeTypesController(EnovaApiControllerDependencies dependencies)
            :base (dependencies)
        {
        ...
        [HttpGet()]
        [AllowAnonymous]
        [ProducesResponseType(typeof(IEnumerable<AttributeTypeModel>), (int)HttpStatusCode.OK)]
        ...
        [HttpGet("{identifier}")]
        [AllowAnonymous]
        [ProducesResponseType(typeof(AttributeTypeModel), (int)HttpStatusCode.OK)]
