...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class CustomerGroupsController : EnovaApiController
    {
        ...
        public CustomerGroupsController(EnovaApiControllerDependencies dependencies)
            : base(dependencies)
        {
        ...
        [HttpGet()]
        [Authorize(Roles = AuthService.AdminRole)]
        [ProducesResponseType(typeof(IEnumerable<CustomerGroupModel>), (int)HttpStatusCode.OK)]
        ...
        [HttpGet("{identifier}")]
        [Authorize(Roles = AuthService.AdminRole)]
        [ProducesResponseType(typeof(CustomerGroupModel), (int)HttpStatusCode.OK)]
        ...
        /// <summary>
        /// Add a dynamic property to a customergroup.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaCustomerGroup>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a customergroup.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaCustomerGroup>(propertyName);
        }
    }
}
