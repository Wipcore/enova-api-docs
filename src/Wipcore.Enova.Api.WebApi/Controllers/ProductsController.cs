...
namespace Wipcore.Enova.Api.WebApi.Controllers
{
    ...
    public class ProductsController : EnovaApiController
    {
        ...
        /// <summary>
        /// Add a dynamic property to a product.
        /// </summary>
        ...
        {
            _objectService.AddProperty<EnovaBaseProduct>(propertyName, propertyType, languageDependant, maxStringLength);
        }

        /// <summary>
        /// Remove a dynamic property from a product.
        /// </summary>
        [HttpPost("RemoveProperty")]
        [Authorize(Roles = AuthService.AdminRole)]
        public void RemoveProperty(string propertyName)
        {
            _objectService.RemoveProperty<EnovaBaseProduct>(propertyName);
        }
