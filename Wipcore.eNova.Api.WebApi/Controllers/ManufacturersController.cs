...
namespace Wipcore.eNova.Api.WebApi.Controllers
{
    ...
    public class ManufacturersController : EnovaApiController
    {
        ...
        {
            return _objectService.Get<EnovaManufacturer>(requestContext, getParameters);
        }
        ...
        {
            return _objectService.Get<EnovaManufacturer>(requestContext, getParameters, identifier);
        }
    }
}
