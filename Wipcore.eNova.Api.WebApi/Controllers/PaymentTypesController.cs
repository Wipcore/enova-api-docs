...
namespace Wipcore.eNova.Api.WebApi.Controllers
{
    ...
    public class PaymentTypesController : EnovaApiController
    {
        ...
        {
            return _objectService.Get<EnovaPaymentType>(requestContext, getParameters);
        }
        ...
        {
            return _objectService.Get<EnovaPaymentType>(requestContext, getParameters, identifier);
        }
    }
}
