...
namespace Wipcore.eNova.Api.WebApi.Controllers
{
    ...
    public class TaxationRulesController : ApiController
    {
        ...
        {
            return _objectService.Get<EnovaTaxationRule>(requestContext, getParameters);
        }

        [HttpGet("{identifier}")]
        public IDictionary<string, object> Get(ContextModel requestContext, GetParametersModel getParameters, string identifier)
        {
            return _objectService.Get<EnovaTaxationRule>(requestContext, getParameters, identifier);
        }
    }
}
