...
namespace Wipcore.eNova.Api.WebApi.Controllers
{
    ...
    public class ShippingTypesController : ApiController
    {
        ...
        public ShippingTypesController(IObjectService objectService)
        {
        ...
        {
            return _objectService.Get<EnovaShippingType>(requestContext, getParameters);
        }

        [HttpGet("{identifier}")]
        public IDictionary<string, object> Get(ContextModel requestContext, GetParametersModel getParameters, string identifier)
        {
            return _objectService.Get<EnovaShippingType>(requestContext, getParameters, identifier);
        }
    }
}
